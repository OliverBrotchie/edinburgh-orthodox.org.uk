<a id="top"></a>
<p align="center">
  <img src="mockups/red-logo-church.jpg" alt="St Andrew's Orthodox Church logo" width="80" />
</p>

<h1 align="center">Edinburgh Orthodox Website</h1>

<p align="center">
  <em>A project board for the redesign of the website of the<br/>Orthodox Community of St Andrew, Edinburgh.</em>
</p>
...
<table>
  <tr>
    <td align="center" padding="16"><h3>📜 Read the plan</h3>The full redesign, in plain English.<br/><code>proposal.md</code></td>
    <td align="center"><h3>🧾 Work the spec</h3>Every need and decision, ready to split into tickets.<br/><code>docs/spec-website-redesign.md</code></td>
    <td align="center"><h3>🎨 See the mockups</h3>Plain HTML/CSS you can open in any browser, now on GitHub Pages.<br/><code>mockups/</code></td>
  </tr>
</table>
